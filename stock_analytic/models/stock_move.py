...
class StockMove(models.Model):
    ...
    def _get_new_picking_values(self):
        ...
        if self.picking_id and self.picking_id.analytic_distribution:
            values['analytic_distribution'] = self.picking_id.analytic_distribution
        return values

    @classmethod
    def _get_fields_stock_picking_to_stock_move(cls):
        """Specify fields to copy from stock.picking to stock.move"""
        return super()._get_fields_stock_picking_to_stock_move() + ['analytic_distribution']
